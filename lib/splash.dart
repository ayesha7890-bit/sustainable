...
class _SplashScreenState extends State<SplashScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Muted earthy linear gradient bg (sage -> moss -> warm sand)
      backgroundColor: const Color(0xFF3E5C50),
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              ...
              Color(0xFFCBBE9C), // warm muted sand
            ],
            stops: [0.0, 0.55, 1.0],
          ),
        ),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: const Color(0xFFEFE9DA).withValues(alpha: 0.35),
                    width: 1,
                  ),
                ),
              ),
                    ...
                    children: [
                      ...
                      _orbitBadge(
                        ...
                        child: const _AppIconBadge(
                            icon: Icons.water_drop, color: Color(0xFF5EC8F2)),
                      ),
                      // HOME / ECO BUILDINGS
                      _orbitBadge(
                        angleDeg: 60,
                      ...
                      _orbitBadge(
                        ...
                        radius: orbitSize / 2,
                        child: const _AppIconBadge(
                            icon: Icons.bolt, color: Color(0xFFFFD166)),
                      ),
                      // ECO LEAF
                      _orbitBadge(
                        angleDeg: 180,
                        radius: orbitSize / 2,
                        child: const _AppIconBadge(
                            icon: Icons.eco, color: Color(0xFF8FE3A3)),
                      ),
                      // RECYCLE ICON
                      _orbitBadge(
                        angleDeg: 240,
                        radius: orbitSize / 2,
                        child: const _AppIconBadge(
                            icon: Icons.recycling, color: Color(0xFF4DB6AC)),
                      ),
                      // SPARKS / STARS
                      _orbitBadge(
                        angleDeg: 300,
...
class _DashedCirclePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color(0xFFEFE9DA).withValues(alpha: 0.55)
...
class _LeafPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final leftLeaf = Path()
      ...
      ..cubicTo(center.dx - 12, center.dy - 16, center.dx - 32,
          center.dy - 16, center.dx - 38, center.dy)
      ..cubicTo(center.dx - 26, center.dy + 8, center.dx - 10, center.dy + 6,
          center.dx, center.dy)
      ..close();
